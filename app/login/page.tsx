  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      ...
      <form onSubmit={handleLogin} className="bg-white p-8 rounded shadow-md w-full max-w-sm">
        <h2 className="text-2xl text-center font-bold mb-4">Employee Login</h2>
        <input
          type="email"
          placeholder="Email"
        ...
        <button
          type="submit"
          className="w-full transition-all bg-blue-600 text-white py-2 rounded hover:bg-blue-700 cursor-pointer"
        >
          Login
        </button>
      </form>
