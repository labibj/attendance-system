    ...
    <main className="p-8">
      ...
      <div className='min-h-screen'>
        ...
        <div className='max-w-10/12'>
          <div className='logo w-48 lg:mb-24 mb-96 relative z-10'>
            <Link href="/">
          ...
          <div className='relative z-10'>
            <h1 className='font-bold text-4xl mb-5 text-[#454545] max-w-2xl'>Welcome to CareSync Health Attendance System</h1>
